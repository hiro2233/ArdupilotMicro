...
void APM2SPIDeviceManager::init(void* machtnichts) {
    ...
    AVRDigitalSource* mpu6k_cs = new AVRDigitalSource(_BV(2), PD);
    ...
    AVRDigitalSource* ms5611_cs = new AVRDigitalSource(_BV(7), PD);
    ...
    AVRDigitalSource* optflow_cs = new AVRDigitalSource(_BV(4), PD);
